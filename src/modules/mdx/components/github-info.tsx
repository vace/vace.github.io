...
export async function GithubInfo({
  ...
  return (
    <a
      ...
      {...props}
      className={cn(
        'flex flex-col gap-1.5 p-2 rounded-lg text-sm text-foreground/80 transition-colors lg:flex-row lg:items-center hover:text-accent-foreground hover:bg-accent',
        props.className,
      )}
    >
      ...
      <p className="flex text-xs items-center gap-1 text-muted-foreground">
